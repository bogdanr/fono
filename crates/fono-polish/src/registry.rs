...
//!
//! Per ADR 0004 we ship only OSI-approved, GPL-compatible defaults. Gemma E2B
//! is Apache-2.0 and is eligible as the shared local cleanup/assistant default.
...
mod tests {
    ...
    fn gemma_e2b_is_apache_multilingual_and_default_eligible() {
        let gemma = PolishRegistry::get("gemma-4-e2b").unwrap();
